...
import type { TopVendedorDescontoDTO } from '@/types/dashboard'

type ChartRow = TopVendedorDescontoDTO & { nome: string }
...
export const TopSellersDiscountChart = memo(function TopSellersDiscountChart({
      ...
      <CardContent className="h-[300px]">
        {chartData.length === 0 ? (
          <p className="flex h-full items-center justify-center text-sm text-muted-foreground">
            Nenhum desconto encontrado para o período selecionado
          </p>
        ) : (
